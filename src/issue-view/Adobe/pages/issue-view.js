  ...
  return (
    <Provider theme={defaultTheme} colorScheme={mode ? "dark" : "light"}>
      <Grid
        ...
        margin="auto"
        areas={{
          base: ["content content", "sidebar sidebar"],
          M: ["content sidebar"],
        }}
        columns={{
          base: ["1fr", "1fr"],
      ...
      >
        <View gridArea="content" marginBottom="size-400">
          <Content marginStart="size-400" marginEnd="size-400">
            ...
            <Tabs aria-label="status tabs" defaultSelectedKey="comments">
              <TabList>
              ...
              <TabPanels marginTop="size-200">
                <Item key="all">All tab</Item>
                <Item key="comments">
                  <Flex>
                    <View>
                      <User marginTop="size-100" size="S" aria-label="user" />
                    </View>
                    <View marginStart="size-100" flex>
                      <TextField width="100%" aria-label="comment" />
                      <Text
                        UNSAFE_style={{ fontSize: "11px", fontWeight: 500 }}
                      >
                ...
                <Item key="history">History tab</Item>
                <Item key="log">Work log tab</Item>
              </TabPanels>
            </Tabs>
          </Content>
        </View>
        <View gridArea="sidebar">
          ...
          >
            <Flex justifyContent="end">
              ...
              >
                {mode ? (
                  <Moon size="M" aria-label="dark mode" isQuiet />
                ) : (
                  <Light size="M" aria-label="light mode" isQuiet />
                )}
              </ActionButton>
              <ActionButton marginStart="size-100" isQuiet>
              ...
              <Flex marginTop="size-150" justifyContent="space-between">
                ...
                >
                  <a href="https://www.adobe.com">
                    <Branch3 marginTop="size-100" size="S" aria-label="git" />{" "}
                    Adobe.com
                  </a>
                </LinkItem>
              </Flex>
